...
$dbc=mysqli_connect('127.0.0.1','root','','test')
    ...
    $query="select * from hiredeal where creator2='{$_SESSION['login_user']}' and status='decline'";
    ...
    $query="select * from copyrightdeal where creator2='{$_SESSION['login_user']}' and status='decline'";
    $result=mysqli_query($dbc,$query);
    $buy='';
    while($row=mysqli_fetch_array($result))
    {
        ...
        $buy.="<div class=\"divid\" style=\"margin-top:-50px\">
                ...
                <h1>{$title}</h1>
                <p>request declined- <a id=\"username\" href=\"profile.php?view={$creatorid}\">@{$username}</a></p>
...
<body style="background-color:#eee;">
        <div class="container">
            ...
            <div class="title">
                <img src="images/rejected.png" align="center"><br>
                <p>Rejected</P>
            </div>
            <div>
            <div class="title2">
                <p style="margin-bottom:0px; margin-top:-100px;"><img src="images/people.png">Hire Requests</p></div>
                <ul class="ch-grid">
<?php echo $hire;?>
            ...
            <div >
            <div class="title2">
                <p><img src="images/articles.png">Buying Requests</p>
            </div>
      <?php echo $buy;?>
</div>
</div>
